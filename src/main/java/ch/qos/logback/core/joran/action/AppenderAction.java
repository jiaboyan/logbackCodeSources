...
// 举例:  <appender name="ma" class="MyAppender" />
public class AppenderAction<E> extends Action {
    Appender<E> appender;
    private boolean inError = false;

    /**
     * 当解析到 <appender name="ma" class="MyAppender" />的时候，调用此方法:
     */
    ...
    public void begin(InterpretationContext ec, String localName, Attributes attributes) throws ActionException {
        ...
        try {
            ...
            //实例化对应的Appender:  例如 ch.qos.logback.core.ConsoleAppender
            ...
            //把这个初始化完毕的MyAppender放到InterpretationContext的AppenderBag里，主要是为了当有地方引用次Appender时候，使用，例如appender-ref
