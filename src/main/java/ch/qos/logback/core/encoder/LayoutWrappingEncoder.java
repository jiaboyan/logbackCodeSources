...
public class LayoutWrappingEncoder<E> extends EncoderBase<E> {
    ...
    public void doEncode(E event) throws IOException {
        ...
        //RollingFileAppender使用输出流ResilientFileOutputStream对象进行日志打印，实际调用的是OutputStream的方法；
        //ConsoleAppender使用的是ConsoleTarget枚举类进行日志输出，实际就是调用  System.out.write(b);打印到控制台；
